...
const SuccessTask = () => {
  ...
  } = useGetQuery(false, "staff-get-task", `users/staff-done-subtasks/?page=${currentPage}&page_size=${pageSize}${ordering && `&ordering=${ordering}`}${deadlineStatus && `&deadline_status__in=${deadlineStatus}`}`);
  ...
  return (
      <div>
        <Row gutter={[16 , 30]}>
          ...
          {/*<FilterTaskList deadlineColorAlert={false} setDeadlineStatus={setDeadlineStatus} setOrdering={setOrdering} />*/}
        </Row>
